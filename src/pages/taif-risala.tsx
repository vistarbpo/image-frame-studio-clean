...
const TAIF_RISALA_FRAME_TYPE = 'taif-risala';

const TaifRisalaFramePage = () => {
      ...
      <div className="flex-grow pb-20">
        <div className="container mx-auto px-4 py-8">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-3xl font-bold text-[#FF5533]">Taif Risala Frame Studio</h1>
          </div>
          {!userImage ? (
            <div className="flex flex-col items-center w-full px-4 animate-fade-in">
              ...
              <div className="w-full max-w-md mb-6">
                <img 
                  src={"/taif-risala/frame.png"}
                  alt="Taif Risala frame"
            ...
            <Suspense fallback={<LoadingSpinner />}>
              <PhotoEditor
                frameType={TAIF_RISALA_FRAME_TYPE}
                userImage={userImage}
                onBack={handleBack}
              />
            </Suspense>
...
export default TaifRisalaFramePage; 