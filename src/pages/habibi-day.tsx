...
const HABIBI_DAY_FRAME_TYPE = 'habibi-day';

const HabibiDayFramePage = () => {
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          {!userImage ? (
            <div className="flex flex-col items-center w-full px-4 animate-fade-in">
              <div className="w-full max-w-md mb-8 relative group">
                ...
                <div className="relative bg-card/50 backdrop-blur-sm rounded-xl p-4 border border-border/50 shadow-2xl">
                  <img 
                    src={"/habibi-day/frame.png"}
                    alt="Habibi Day frame"
            ...
            <Suspense fallback={<LoadingSpinner />}>
              <PhotoEditor
                frameType={HABIBI_DAY_FRAME_TYPE}
                userImage={userImage}
                divisionName=""
                onBack={handleBack}
              />
...
export default HabibiDayFramePage;
